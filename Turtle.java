...
public class Turtle implements Runnable, ActionListener, MouseListener, MouseMotionListener, KeyListener, ComponentListener, MouseWheelListener
{
    ...
    {
        new Thread(new Bob(0,0,"blue",600)).start();
        new Thread(new Bob(150, 150, "pink",300)).start();
        new Thread(new Bob(-125, 125, "yelllow",150)).start();
        new Thread(new Bob(-100, 85, "red",750)).start();
            new Thread(new Bob(0,0,"blue",600)).start();
        new Thread(new Bob(100, 200, "pink",300)).start();
        new Thread(new Bob(-200, 50, "yelllow",150)).start();
        new Thread(new Bob(-100, 85, "red",750)).start();
    }
